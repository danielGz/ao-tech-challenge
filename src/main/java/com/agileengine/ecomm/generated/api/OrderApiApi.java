...
import com.agileengine.ecomm.generated.model.Order;
...
@Validated
@Tag(name = "OrderApi", description = "the OrderApi API")
public interface OrderApiApi {
    ...
    ResponseEntity<Order> ordersIdGet(
        @Parameter(name = "id", description = "", required = true, in = ParameterIn.PATH) @PathVariable("id") String id
    ) throws Exception;
